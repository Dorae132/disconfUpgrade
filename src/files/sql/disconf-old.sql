...
CREATE TABLE `app` (
  ...
  PRIMARY KEY (`app_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='app';
...
INSERT INTO `area` VALUES ('2', '上海', 'https://127.0.0.1:81', 'admin', 'admin');
...
) ENGINE=InnoDB AUTO_INCREMENT=556 DEFAULT CHARSET=utf8 COMMENT='配置';
...
INSERT INTO `config` VALUES ('169', '1', '0', 'a', 'a', '1', '1_0_0_0', '1', '20170208142159', '20170208142333');
INSERT INTO `config` VALUES ('170', '0', '0', 'b.xml', '<a>\n  <C>C</C>\n  <cc>dsdf</cc>\n</a>', '1', '1_0_0_0', '1', '20170208142240', '20170208142329');
INSERT INTO `config` VALUES ('171', '0', '1', 'haha.properties', 'key=123\nval=456789', '1', '1_0_0_0', '1', '20170208142436', '20170208145850');
...
-- ----------------------------
INSERT INTO `config_history` VALUES ('46', '169', '', 'a', '20170208142159', '1');
INSERT INTO `config_history` VALUES ('47', '170', '', '<a>\n  <C>C</C>\n</a>', '20170208142240', '1');
INSERT INTO `config_history` VALUES ('48', '170', '<a>\n  <C>C</C>\n</a>', '<a>\n  <C>C</C>\n  <cc>dsdf</cc>\n</a>', '20170208142312', '1');
INSERT INTO `config_history` VALUES ('49', '170', '<a>\n  <C>C</C>\n  <cc>dsdf</cc>\n</a>', '', '20170208142329', '1');
INSERT INTO `config_history` VALUES ('50', '169', 'a', '', '20170208142333', '1');
INSERT INTO `config_history` VALUES ('51', '171', '', 'key=123\r\nval=456', '20170208142436', '1');
INSERT INTO `config_history` VALUES ('52', '171', 'key=123\r\nval=456', 'key=123\nval=456789', '20170208145850', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='用户角色_url访问权限表';
...
INSERT INTO `role_resource` VALUES ('4', '1', '/api/app/add', '生成一个app', '0000', '99991231235959');
INSERT INTO `role_resource` VALUES ('5', '2', '/api/app/add', '生成一个app', '0010', '99991231235959');
INSERT INTO `role_resource` VALUES ('6', '3', '/api/app/add', '生成一个app', '0000', '99991231235959');
...
INSERT INTO `role_resource` VALUES ('79', '2', '/api/area/add', '增加区域', '0010', '99991231235959');
INSERT INTO `role_resource` VALUES ('80', '2', '/api/area/delete', '删除区域', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('81', '2', '/api/area/list', '枚举区域', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('82', '2', '/api/app/listapp', '枚举应用', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('83', '2', '/api/app/delete', '删除应用', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('84', '2', '/api/data/list', '枚举数据', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('85', '2', '/api/data/getCount', '获取数据结果', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('86', '2', '/api/data/db2Api', '数据导出', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('87', '2', '/api/data/api2Db', '数据导入', '0010', '99991231235959');
INSERT INTO `role_resource` VALUES ('88', '2', '/api/web/config/notifyOne', '通知一个', '1000', '99991231235959');
INSERT INTO `role_resource` VALUES ('89', '2', '/api/web/config/notifySome', '通知多个', '1000', '99991231235959');
